...
const sideFixedMenu = $(".fixed-menu");
const menuItems = sideFixedMenu.find("fixed-menu__item");
...
const changeMenuThemeForSection = sectionEq => {
  ...
  const activeClass = "fixed-menu_shadowed";
    ...
    if (menuTheme == "black") {
      sideFixedMenu.addClass(activeClass);
    } else {
      sideFixedMenu.removeClass(activeClass);
    }
};
